...
String[] BRC_ids = new String[] {"init","search","Display","Stop","GoOnce","frames","maze","randsize","method"};
String[] BRC_values = new String[] {"0","0","0","0","0","10","E","20","DFS"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"BUTTON\",\"brc_1\",\"init\"],\n"
+ "[\"BUTTON\",\"brc_2\",\"search\"],\n"
+ "[\"BUTTON\",\"brc_3\",\"Display\"],\n"
+ "[\"BUTTON\",\"brc_4\",\"Stop\"],\n"
+ "[\"BUTTON\",\"brc_5\",\"GoOnce\"],\n"
+ "[\"RANGE\",\"brc_6\",\"frames\",\"brc_7\"],\n"
+ "[\"DROPDOWN\",\"brc_8\",\"maze\"],\n"
+ "[\"RANGE\",\"brc_9\",\"randsize\",\"brc_10\"],\n"
+ "[\"DROPDOWN\",\"brc_11\",\"method\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<table><tr><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Initialize\" onClick=\"SendNameValue('init='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Search\" onClick=\"SendNameValue('search='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Display\" onClick=\"SendNameValue('Display='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Stop\" onClick=\"SendNameValue('Stop='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Go Once\" onClick=\"SendNameValue('GoOnce='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_6\" name=\"brc_6\" min=\"5\" max=\"120\" value=\"10\" step=\"5\"\n"
+ "  oninput=\"ShowRange('brc_6','brc_7','frames');\" />  120<br/>\n"
+ "  Frames Per Second: <label id=\"brc_7\"></label>\n"
+ "  </td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">Maze Difficulty:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_8\" id=\"brc_8\" onchange=\"SendNameValue('maze='+document.brc.brc_8.value);\">\n"
+ "<option selected=\"selected\" value=\"E\">Easy</option>\n"
+ "<option  value=\"M\">Medium</option>\n"
+ "<option  value=\"H\">Hard</option>\n"
+ "<option  value=\"R\">Random</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">2  \n"
+ "    <input type=\"range\" id=\"brc_9\" name=\"brc_9\" min=\"2\" max=\"100\" value=\"20\" step=\"2\"\n"
+ "  oninput=\"ShowRange('brc_9','brc_10','randsize');\" />  100<br/>\n"
+ "  Frames Per Second: <label id=\"brc_10\"></label>\n"
+ "  </td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">Searching Method:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_11\" id=\"brc_11\" onchange=\"SendNameValue('method='+document.brc.brc_11.value);\">\n"
+ "<option selected=\"selected\" value=\"DFS\">Depth First Search</option>\n"

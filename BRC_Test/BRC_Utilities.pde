...
String[] BRC_ids = new String[] {"start","stop","color","yvel","xvel"};
String[] BRC_values = new String[] {"0","0","WHITE","10","10"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"BUTTON\",\"brc_1\",\"start\"],\n"
+ "[\"BUTTON\",\"brc_2\",\"stop\"],\n"
+ "[\"RADIO\",\"brc_3\",\"color\"],\n"
+ "[\"RANGE\",\"brc_4\",\"yvel\",\"brc_5\"],\n"
+ "[\"RANGE\",\"brc_6\",\"xvel\",\"brc_7\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<table><tr><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"start\" onClick=\"SendNameValue('start='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"stop\" onClick=\"SendNameValue('stop='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table cellpadding=\"3\"><tr><td class=\"auto-style1\">color::&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"WHITE\" onclick=\"SendNameValue('color=WHITE');\"  checked=\"checked\" /> white&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"RANDOM\" onclick=\"SendNameValue('color=RANDOM');\"   /> random&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"RED\" onclick=\"SendNameValue('color=RED');\"   /> red&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"GREEN\" onclick=\"SendNameValue('color=GREEN');\"   /> green&nbsp;&nbsp;&nbsp;\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">0  \n"
+ "    <input type=\"range\" id=\"brc_4\" name=\"brc_4\" min=\"0\" max=\"30\" value=\"10\" step=\"2\"\n"
+ "	oninput=\"ShowRange('brc_4','brc_5','yvel');\" />  30<br/>\n"
+ "	Y_Velocity: <label id=\"brc_5\"></label>\n"
+ "	</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">0  \n"
+ "    <input type=\"range\" id=\"brc_6\" name=\"brc_6\" min=\"0\" max=\"30\" value=\"10\" step=\"2\"\n"
+ "	oninput=\"ShowRange('brc_6','brc_7','xvel');\" />  30<br/>\n"
+ "	X_Velocity: <label id=\"brc_7\"></label>\n"
+ "	</td></tr></table>\n"
+ "\n"
+ "</td></tr></table>\n"
+ "\n"

...
String[] BRC_ids = new String[] {"username","restart","mines","size","mines","difficulty"};
...
+ "[\"TEXT\",\"brc_2\",\"username\"],\n"
+ "[\"BUTTON\",\"brc_3\",\"restart\"],\n"
+ "[\"RANGE\",\"brc_4\",\"mines\",\"brc_5\"],\n"
+ "[\"MONITOR\",\"brc_6\",\"time\"],\n"
+ "[\"NOTE\",\"brc_7\",\"pb\"],\n"
+ "[\"MONITOR\",\"brc_8\",\"pbe\"],\n"
+ "[\"MONITOR\",\"brc_9\",\"pbm\"],\n"
+ "[\"MONITOR\",\"brc_10\",\"pbh\"],\n"
+ "[\"MONITOR\",\"brc_11\",\"pbi\"],\n"
+ "[\"RANGE\",\"brc_12\",\"size\",\"brc_13\"],\n"
+ "[\"RANGE\",\"brc_14\",\"mines\",\"brc_15\"],\n"
+ "[\"DROPDOWN\",\"brc_16\",\"difficulty\"]];\n"
+ "\n"
+ "Monitor = true;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<table><tr><td><table><tr><td class=\"auto-style1\"><label id=\"brc_1\">To change the settings<br/><a href=\"127.0.0.1:10002\">Go to this site</a></label></td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">\n"
+ "First name: <input type=\"text\" name=\"brc_2\" id=\"brc_2\" onchange=\"SendNameValue('username='+document.getElementById('brc_2').value);\" /> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"restart\" onClick=\"SendNameValue('restart='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_4\" name=\"brc_4\" min=\"5\" max=\"50\" value=\"16\" step=\"1\"\n"
+ "	oninput=\"ShowRange('brc_4','brc_5','mines');\" />  50<br/>\n"
+ "	number of mines: <label id=\"brc_5\"></label>\n"
+ "	</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">stopwatch <label id=\"brc_6\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\"><label id=\"brc_7\">personal bests</label></td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Easy Personal Best <label id=\"brc_8\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Medium Personal Best <label id=\"brc_9\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Hard Personal Best <label id=\"brc_10\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">Insane Personal Best <label id=\"brc_11\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_12\" name=\"brc_12\" min=\"5\" max=\"30\" value=\"16\" step=\"1\"\n"
+ "	oninput=\"ShowRange('brc_12','brc_13','size');\" />  30<br/>\n"
+ "	size x size tiles: <label id=\"brc_13\"></label>\n"
+ "	</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">5  \n"
+ "    <input type=\"range\" id=\"brc_14\" name=\"brc_14\" min=\"5\" max=\"50\" value=\"16\" step=\"1\"\n"
+ "	oninput=\"ShowRange('brc_14','brc_15','mines');\" />  50<br/>\n"
+ "	number of mines: <label id=\"brc_15\"></label>\n"
+ "	</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_16\" id=\"brc_16\" onchange=\"SendNameValue('difficulty='+document.brc.brc_16.value);\">\n"
